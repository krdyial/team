...
Feature: US1002_user_should_add_data_with_parameter
  ...
  Scenario: TC01_Testing_the_data_tables_web_page
    ...
    When user enters the firstname "Jerry"
    When user enters the lastname "Rodman"
    When user enters the position "Forward"
    When user enters the office "chicago"
    When user enters the extension "172839"
    When user enters the startdate "2020-10-10"
    When user enters the salary "38000"
    And user clicks on the create button
    And search for the first name "Jerry"
    Then verify the name fields contains first name "Jerry"

  @regression
  Scenario: TC02_Testing_the_data_tables_web_page
    Given user is on the datatables page
    And user clicks on the new button
    When user enters the firstname "Kemal"
    When user enters the lastname "Sunal"
    When user enters the position "Cow"
    When user enters the office "Istanbuö"
    When user enters the extension "172839"
    When user enters the startdate "2020-10-10"
    When user enters the salary "38000"
    And user clicks on the create button
    And search for the first name "Kemal"
    Then verify the name fields contains first name "Kemal"
